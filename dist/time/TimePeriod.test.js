...
describe('TimePeriod', () => {
    describe('TimePeriod.fromStr', () => {
        it('should parse single values', () => {
            expect(TimePeriod_1.TimePeriod.fromStr('67')).toEqual(67);
        ...
        it('should parse mixed values', () => {
            expect(TimePeriod_1.TimePeriod.fromStr('13s456')).toEqual(13 * 1000 +
                456);
            ...
            expect(TimePeriod_1.TimePeriod.fromStr('3h13m37s')).toEqual(3 * 60 * 60 * 1000 +
                13 * 60 * 1000 +
                37 * 1000);
            expect(TimePeriod_1.TimePeriod.fromStr('4d7h23m57s697')).toEqual(4 * 24 * 60 * 60 * 1000 +
                7 * 60 * 60 * 1000 +
                23 * 60 * 1000 +
                57 * 1000 +
                697);
        ...
        it('should not parse invalid values', () => {
            expect(() => TimePeriod_1.TimePeriod.fromStr('1s1200')).toThrow();
